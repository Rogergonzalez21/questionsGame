...
urlpatterns = [
    ...
    url(r'^questions/question-detail/(?P<question_id>\d+)/right/$', views.right_question, name='right_question'),
    url(r'^questions/question-detail/(?P<question_id>\d+)/wrong/$', views.wrong_question, name='wrong_question'),
